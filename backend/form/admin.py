...
class MultipleChooseQuestionInline(admin.TabularInline):
...
class FormAdmin(admin.ModelAdmin):
    ...
    inlines = [MultipleChooseQuestionInline, TextQuestionInline]
...
admin.site.register(MultipleChooseQuestion)
